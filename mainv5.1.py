...
avg_Time = 15 #Number of Temp Reads in array average
    ...
    def run(self):
        ...
        while (i < self.avg_Time): # Fill array with valid data
            ...
            if self.pull_data():
                ...
                pulls_left = self.avg_Time - i
                msg = ("Data Pulls Left " + str(pulls_left))
                self.mq.publish("/tstat/living/temp", msg)
        ...
        while (end_Thread == 0):
            ...
            try:
                if (startup == 0): ## Only do Logic after initial temp average
                    ...
                    if (float(set_Temp) > 70):
                        sql_update('settemp', '65', zone, "Initial Setup - Clear Relay in DB")
                        log("Safeguard Cutout Temp over 70")
